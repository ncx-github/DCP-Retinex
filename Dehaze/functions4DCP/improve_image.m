function [radiance2,transmission2,new_airlight] = improve_image(image,rep_atmosphere,omega,r,eps,s)
    [m,n,~]=size(image);
    ...
    trans2=1-omega.*new_dc; % rough transmission map
    
	transmission2=fastguidedfilter(rgb2gray(image),trans2, r, eps, s);
