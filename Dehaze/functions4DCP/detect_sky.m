...
image_norm=imresize(image_norm,[a b]);% scale image
...
edges_filt=edges_lab>0.025; % better not less than 0.02, not more than 0.05

mask_m_dc=dc>0.875; % better not less than 0.8
